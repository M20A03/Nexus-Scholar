...
export interface ORKGPaper {
  ...
  pdfUrl: string;
  openAccess: boolean;
  authors: { id: string; name: string; department?: string; orcid?: string }[];
  researchProblemId: string;
  researchProblemName: string;
...
export const MOCK_PAPERS: ORKGPaper[] = [
  {
    "id": "paper-1706-03762",
...
export const MOCK_COMPARISONS: ORKGComparison[] = [
  {
    id: 'comp-1',
